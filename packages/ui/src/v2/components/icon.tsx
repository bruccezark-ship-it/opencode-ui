...
const icons = {
  ...
  magic: {
    viewBox: "0 0 16 16",
    body: `<path d="M8.5 1.5L9.8 5.2L13.5 6.5L9.8 7.8L8.5 11.5L7.2 7.8L3.5 6.5L7.2 5.2L8.5 1.5Z" stroke="currentColor" stroke-linejoin="round"/><path d="M12.5 10.5L13.2 12.6L15.3 13.3L13.2 14L12.5 16.1L11.8 14L9.7 13.3L11.8 12.6L12.5 10.5Z" stroke="currentColor" stroke-linejoin="round"/><path d="M3.5 10.5L4.4 13.1L7 14L4.4 14.9L3.5 17.5L2.6 14.9L0 14L2.6 13.1L3.5 10.5Z" stroke="currentColor" stroke-linejoin="round"/>`,
  },
  archive: {
    viewBox: "0 0 16 16",
