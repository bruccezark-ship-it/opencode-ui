...
export const dict = {
  ...
  "session.preview.urlPlaceholder": "项目开发服务器地址",
  "session.preview.go": "前往",
  "session.preview.refresh": "刷新",
  "session.preview.stop": "停止开发服务器",
  "session.preview.stopped": "开发服务器已停止。点击刷新可重新启动。",
  "session.preview.reset": "恢复自动检测",
  "session.preview.openExternal": "在浏览器中打开",
  "session.preview.magic": "魔法编辑",
  "session.preview.magic.hint": "默认用框选精准定位；也可切换圈选。填写提示词后提交，按 Esc 取消。",
  "session.preview.magic.modeRect": "框选",
  "session.preview.magic.modeFreehand": "圈选",
  "session.preview.magic.undo": "撤销",
  "session.preview.magic.clear": "清空",
  "session.preview.magic.sourceFile": "源文件：{{path}}",
  "session.preview.magic.savedAttachment": "参考附件：{{filename}}（{{path}}）",
  "session.preview.magic.promptPlaceholder": "例如：把这个按钮改成圆角红色；或上传图片后输入「将选区图片替换为该图片」",
  "session.preview.magic.promptLabel": "描述要如何修改选中的区域",
  "session.preview.magic.attachmentLabel": "参考附件（可选）",
  "session.preview.magic.uploadAttachment": "上传图片",
  "session.preview.magic.removeAttachment": "移除附件",
  "session.preview.magic.attachmentLimit": "最多上传 3 张图片",
  "session.preview.magic.invalidAttachment": "仅支持 PNG、JPEG、GIF、WebP 图片",
  "session.preview.magic.selectFirstHint": "请先在预览上框选或圈选要修改的区域",
  "session.preview.magic.submit": "提交到 Agent",
  "session.preview.magic.sending": "正在提交…",
  "session.preview.magic.sent": "已提交给 Agent",
  "session.preview.magic.sendFailed": "无法发送给 Agent",
  "session.preview.magic.sendFailed.description": "请检查 Agent、模型和会话状态后重试。",
  "session.preview.magic.noSession": "当前没有可用的会话",
  "session.preview.magic.noModel": "请先选择 Agent 和模型",
  "session.preview.magic.captureFailed": "无法截取预览页面",
  "session.preview.magic.captureFailed.description": "请刷新预览后重试。",
  "session.preview.magic.attachmentSaveFailed": "无法保存参考附件到宿主机",
  "session.preview.magic.attachmentSaveFailed.description": "请检查 opencode serve 连接后重试。",
  "session.preview.magic.color.red": "红色",
  "session.preview.magic.color.blue": "蓝色",
  "session.preview.magic.color.green": "绿色",
  "session.preview.magic.color.yellow": "黄色",
  "session.preview.magic.color.purple": "紫色",
  "session.preview.magic.color.orange": "橙色",
  "session.preview.empty": "输入 URL 以预览应用",
  "session.preview.detecting": "正在分析项目结构...",
  "session.preview.checking": "正在检查开发服务器是否已运行...",
  "session.preview.starting": "正在启动项目开发服务器...",
  "session.preview.waiting": "开发服务器启动中，等待预览可用...",
  "session.preview.failed": "无法启动开发服务器。请检查终端输出，或点击刷新重试。",
  "session.preview.command": "启动命令：{{command}}",
  "session.preview.exitCode": "退出码：{{code}}",
  "session.preview.noProject": "工作区中未检测到可运行的项目。",
  "session.preview.noProjectHint": "请添加 package.json、index.html 或 Python 项目，或在上方手动输入地址。",
  "session.preview.noDevScript": "package.json 中未找到 dev/start 脚本。",
  "session.preview.publish": "发布",
  "session.preview.publishCos": "COS发布",
  "session.preview.publishCos.title": "发布到腾讯云 COS",
  "session.preview.publishCos.project": "项目：{{name}}",
  "session.preview.publishCos.mode": "发布方式",
  "session.preview.publishCos.modeSubdomain": "子域名",
  "session.preview.publishCos.modeDomain": "完整域名",
  "session.preview.publishCos.subdomain": "子域名",
  "session.preview.publishCos.domain": "完整域名",
  "session.preview.publishCos.subdomainPlaceholder": "例如 my-app",
  "session.preview.publishCos.domainPlaceholder": "例如 app.example.com",
  "session.preview.publishCos.subdomainHint": "将发布至 {{baseDomain}} 下的子域名",
  "session.preview.publishCos.protocol": "访问协议",
  "session.preview.publishCos.cdnHttps": "开启 CDN HTTPS",
  "session.preview.publishCos.certId": "CDN 证书 ID",
  "session.preview.publishCos.certIdPlaceholder": "开启 HTTPS 时必填",
  "session.preview.publishCos.preview": "预览发布计划",
  "session.preview.publishCos.previewUrls": "访问地址：{{urls}}",
  "session.preview.publishCos.previewCdn": "加速域名：{{domains}}",
  "session.preview.publishCos.previewCos": "COS 路径：{{path}}",
  "session.preview.publishCos.previewExpanded": "将同时配置：{{domains}}",
  "session.preview.publishCos.previewSkipCdn": "CDN 已存在，将仅上传 COS",
  "session.preview.publishCos.confirm": "确认发布",
  "session.preview.publishCos.success": "发布成功",
  "session.preview.publishCos.cosPath": "COS 路径：{{path}}",
  "session.preview.publishCos.cdnCname": "CDN {{domain}}：{{cname}}",
  "session.preview.publishCos.failed": "发布失败",
  "session.preview.publishCos.previewFailed": "无法预览发布计划",
  "session.preview.publishCos.serverUnavailable": "无法启动发布进程，请确认已配置 VITE_DEPLOY_CLI_SCRIPT 且 opencode serve 所在机器已安装 Bun",
  "session.preview.publishCos.configMissing": "未找到发布配置，请先运行: node packages/deploy-server/dist/cli.js config",
  "session.preview.publishCos.verificationTitle": "CDN 域名归属验证：{{domain}}",
  "session.preview.publishCos.verificationZone": "解析区域：{{zone}}",
  "session.preview.publishCos.verificationType": "记录类型：{{type}}",
  "session.preview.publishCos.verificationHost": "主机记录：{{host}}",
  "session.preview.publishCos.verificationValue": "记录值：{{value}}",
  "session.preview.publishCos.verificationFqdn": "完整主机：{{fqdn}}",
  "session.preview.publishCos.verify": "开始验证",
  "session.preview.publishCos.verificationPending": "已发送验证请求，正在检查 DNS 记录…",
  "session.preview.publishCos.refreshVerification": "刷新验证信息",
  "session.preview.publishCos.verifyFailed": "验证失败",
  "session.preview.publishCos.domainTaken": "以下域名已被其他项目使用：{{domains}}",
  "session.preview.publishCos.routeDiscoveryTitle": "检测到路由文件，请选择链接发现方式",
  "session.preview.publishCos.routeDiscoveryCount": "共 {{count}} 条路由",
  "session.preview.publishCos.routeDiscoveryUseFile": "使用此路由文件",
  "session.preview.publishCos.routeDiscoveryUseBrowser": "改用浏览器爬取",
  "session.preview.publishCos.routeDiscoveryFailed": "路由选择失败",
  "session.preview.publishServer": "Server发布",
  "session.preview.publishServer.title": "发布到服务器",
  "session.preview.publishServer.host": "服务器主机 IP",
  "session.preview.publishServer.hostPlaceholder": "例如 192.168.1.100",
  "session.preview.publishServer.username": "用户名",
  "session.preview.publishServer.password": "密码",
  "session.preview.publishServer.passwordPlaceholder": "SSH 登录密码",
  "session.preview.publishServer.domain": "站点域名",
  "session.preview.publishServer.domainPlaceholder": "例如 www.example.com",
  "session.preview.publishServer.protocol": "传输协议",
  "session.preview.publishServer.path": "远程路径",
  "session.preview.publishServer.hint": "填写域名、传输协议、服务器 IP、用户名、密码和远程路径。将自动构建并生成 sitemap.xml、robots.txt 与页面 md，再上传 dist；域名、协议、主机 IP 与路径会保存到 server-config.json。",
  "session.preview.publishServer.confirm": "确认发布",
  "session.preview.publishServer.success": "发布成功",
  "session.preview.publishServer.resultUrl": "站点地址：{{url}}",
  "session.preview.publishServer.resultHost": "服务器：{{host}}",
  "session.preview.publishServer.resultPath": "远程路径：{{path}}",
  "session.preview.publishServer.resultUploaded": "已上传 {{count}} 个文件",
  "session.preview.publishServer.failed": "Server 发布失败",
  "session.preview.publishServer.requiredFields": "请填写站点域名、服务器 IP 和密码",
  "session.preview.publishServer.incomplete": "发布未正常完成，请查看错误信息",
  "session.preview.publishServer.starting": "正在启动发布进程…",
  "session.preview.publishServer.routeDiscoveryTitle": "检测到路由文件，请选择链接发现方式",
  "session.preview.publishServer.routeDiscoveryCount": "共 {{count}} 条路由",
  "session.preview.publishServer.routeDiscoveryUseFile": "使用此路由文件",
  "session.preview.publishServer.routeDiscoveryUseBrowser": "改用浏览器爬取",
  "session.preview.publishServer.routeDiscoveryFailed": "路由选择失败",
  "session.preview.undeploy": "下线",
  "session.preview.undeployCos.title": "下线域名：{{domain}}",
  "session.preview.undeployCos.loading": "正在加载域名列表…",
  "session.preview.undeployCos.empty": "暂无已发布域名",
  "session.preview.undeployCos.success": "下线成功",
  "session.preview.undeployCos.domain": "域名：{{domain}}",
  "session.preview.undeployCos.cdnStatus": "CDN：{{status}}",
  "session.preview.undeployCos.dnsStatus": "DNS：{{status}}",
  "session.preview.undeployCos.cosDeleted": "已删除 {{count}} 个 COS 对象",
  "session.preview.undeployCos.cosSkipped": "已保留 COS 资源",
  "session.preview.undeployCos.failed": "下线失败",
  "session.preview.gitflow": "GitFlow",
  "session.preview.gitflow.title": "GitFlow CI/CD 工作流生成",
  "session.preview.gitflow.detecting": "正在检测项目结构…",
  "session.preview.gitflow.detectFailed": "项目检测失败",
  "session.preview.gitflow.detection": "项目检测结果",
  "session.preview.gitflow.configure": "请配置部署工作流",
  "session.preview.gitflow.routeCandidates": "路由候选",
  "session.preview.gitflow.projectDir": "项目目录",
  "session.preview.gitflow.defaultDomain": "默认域名",
  "session.preview.gitflow.monorepoType": "Monorepo",
  "session.preview.gitflow.workspaceRoot": "根目录",
  "session.preview.gitflow.packageName": "包名",
  "session.preview.gitflow.notFound": "(未找到)",
  "session.preview.gitflow.notSet": "(未设置)",
  "session.preview.gitflow.routesFileSelect": "选择路由文件",
  "session.preview.gitflow.routesFileCustom": "路由文件路径（可自定义）",
  "session.preview.gitflow.parsedRoutes.title": "解析出的路由",
  "session.preview.gitflow.parsedRoutes.loading": "正在解析路由…",
  "session.preview.gitflow.parsedRoutes.count": "共 {{count}} 个路由",
  "session.preview.gitflow.parsedRoutes.empty": "未能解析到任何路由路径",
  "session.preview.gitflow.parsedRoutes.failed": "路由解析失败",
  "session.preview.gitflow.parsedRoutes.fileMissing": "未找到路由文件或无法读取",
  "session.preview.gitflow.subprojectPackageManager": "子项目包管理器",
  "session.preview.gitflow.workingDirectory": "工作目录：{{path}}",
  "session.preview.gitflow.framework": "框架",
  "session.preview.gitflow.bundler": "打包器",
  "session.preview.gitflow.language": "语言",
  "session.preview.gitflow.packageManager": "包管理器",
  "session.preview.gitflow.monorepo": "子项目路径",
  "session.preview.gitflow.routesFile": "路由文件路径",
  "session.preview.gitflow.branch": "部署分支",
  "session.preview.gitflow.domain": "站点域名（不含协议）",
  "session.preview.gitflow.protocol": "协议",
  "session.preview.gitflow.installCmd": "安装命令",
  "session.preview.gitflow.buildCmd": "构建命令",
  "session.preview.gitflow.commandsTitle": "CI 执行命令",
  "session.preview.gitflow.generate": "生成文件",
  "session.preview.gitflow.generating": "正在生成…",
  "session.preview.gitflow.success": "GitFlow 文件已生成",
  "session.preview.gitflow.successDetail": "以下文件已写入项目：",
  "session.preview.gitflow.secretsTitle": "接下来请在 GitHub 仓库设置以下 Secrets：",
  "session.preview.gitflow.optional": "可选",
  "session.preview.gitflow.pushHint": "推送至 {{branch}} 分支即可自动触发部署！",
  "session.preview.gitflow.failed": "生成失败",
  "session.preview.gitflow.retry": "重试",
  "session.preview.gitflow.workspaceWarning": "当前位于 pnpm workspace 根目录，请在 Vite 子项目目录下运行。",
  "session.preview.gitflow.workspaceWarningExample": "例如: cd apps/web && gitflow",
  ...
  "github.menu.tooltip": "GitHub 项目",
  "github.menu.title": "公开仓库",
  "github.menu.search": "搜索仓库",
  "github.menu.loading": "正在加载仓库…",
  "github.menu.empty": "未找到公开仓库",
  "github.menu.disconnect": "断开连接",
  "github.connect.title": "连接 GitHub",
  "github.connect.description": "连接 GitHub 账号后，可浏览公开仓库并在本机当前目录打开。",
  "github.connect.action": "连接 GitHub",
  "github.connect.inProgress": "正在连接 GitHub…",
  "github.connect.device.action": "使用 GitHub 设备登录",
  "github.connect.device.prefix": "请访问 ",
  "github.connect.device.link": "GitHub",
  "github.connect.device.suffix": " 并输入以下验证码。",
  "github.connect.device.code": "验证码",
  "github.connect.device.waiting": "等待授权…",
  "github.connect.token.action": "使用 Personal Access Token",
  "github.connect.token.label": "Personal Access Token",
  "github.connect.token.placeholder": "ghp_…",
  "github.open.failed": "打开仓库失败",
  "github.open.missingDirectory": "无法获取当前工作目录，请先打开一个项目。",
