...
export const dict = {
  ...
  "session.preview.target": "预览地址：{{url}}",
  "session.preview.go": "前往",
  "session.preview.refresh": "刷新",
  "session.preview.stop": "停止开发服务器",
  "session.preview.stopped": "开发服务器已停止。点击刷新可重新启动。",
  "session.preview.edit": "编辑",
  "session.preview.editModeOn": "进入编辑模式，点击页面元素添加到上下文",
  "session.preview.editModeOff": "退出编辑模式",
  "session.preview.editHint": "点击预览页面中的元素，将其加入提示词上下文（已选 {{count}} 个）",
  "session.preview.inspectorUnavailable": "元素选择器尚未就绪。请先停止并刷新预览，以注入编辑脚本。",
