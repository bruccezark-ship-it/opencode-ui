export const dict = {
  ...
  "session.preview.target": "Preview: {{url}}",
  ...
  "session.preview.edit": "Edit",
  "session.preview.editModeOn": "Enter edit mode and click page elements to add context",
  "session.preview.editModeOff": "Exit edit mode",
  "session.preview.editHint": "Click elements in the preview to add them to the prompt context ({{count}} selected)",
  "session.preview.inspectorUnavailable": "Element picker is not ready yet. Stop and refresh the preview to inject the edit script.",
