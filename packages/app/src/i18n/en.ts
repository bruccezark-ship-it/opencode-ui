export const dict = {
  ...
  "session.preview.urlPlaceholder": "Project dev server URL",
  "session.preview.go": "Go",
  "session.preview.refresh": "Refresh",
  "session.preview.stop": "Stop dev server",
  "session.preview.stopped": "Dev server stopped. Click refresh to start again.",
  "session.preview.reset": "Use auto-detected URL",
  "session.preview.openExternal": "Open in browser",
  "session.preview.magic": "Magic edit",
  "session.preview.magic.hint": "Use box select for precise targeting, or switch to freehand. Describe the change and submit. Press Esc to cancel.",
  "session.preview.magic.modeRect": "Box",
  "session.preview.magic.modeFreehand": "Draw",
  "session.preview.magic.undo": "Undo",
  "session.preview.magic.clear": "Clear",
  "session.preview.magic.sourceFile": "Source file: {{path}}",
  "session.preview.magic.savedAttachment": "Reference attachment: {{filename}} ({{path}})",
  "session.preview.magic.promptPlaceholder": "e.g. Make this button rounded and red; or upload an image and say \"Replace the selected image with this one\"",
  "session.preview.magic.promptLabel": "Describe how to change the selected area",
  "session.preview.magic.attachmentLabel": "Reference attachments (optional)",
  "session.preview.magic.uploadAttachment": "Upload image",
  "session.preview.magic.removeAttachment": "Remove attachment",
  "session.preview.magic.attachmentLimit": "You can upload up to 3 images",
  "session.preview.magic.invalidAttachment": "Only PNG, JPEG, GIF, or WebP images are supported",
  "session.preview.magic.selectFirstHint": "Draw a box or outline around the area you want to edit",
  "session.preview.magic.submit": "Send to Agent",
  "session.preview.magic.sending": "Sending…",
  "session.preview.magic.sent": "Sent to Agent",
  "session.preview.magic.sendFailed": "Could not send to Agent",
  "session.preview.magic.sendFailed.description": "Check the agent, model, and session state, then try again.",
  "session.preview.magic.noSession": "No active session available",
  "session.preview.magic.noModel": "Select an agent and model first",
  "session.preview.magic.captureFailed": "Could not capture the preview page",
  "session.preview.magic.captureFailed.description": "Refresh the preview and try again.",
  "session.preview.magic.attachmentSaveFailed": "Could not save reference attachments to the host",
  "session.preview.magic.attachmentSaveFailed.description": "Check the opencode serve connection and try again.",
  "session.preview.magic.color.red": "red",
  "session.preview.magic.color.blue": "blue",
  "session.preview.magic.color.green": "green",
  "session.preview.magic.color.yellow": "yellow",
  "session.preview.magic.color.purple": "purple",
  "session.preview.magic.color.orange": "orange",
  "session.preview.empty": "Enter a URL to preview your app",
  "session.preview.detecting": "Analyzing project structure...",
  "session.preview.checking": "Checking if the dev server is running...",
  "session.preview.starting": "Starting the project dev server...",
  "session.preview.waiting": "Dev server is starting, waiting for the preview to become available...",
  "session.preview.failed": "Could not start the dev server. Check the terminal output or refresh to retry.",
  "session.preview.command": "Command: {{command}}",
  "session.preview.exitCode": "Exit code: {{code}}",
  "session.preview.noProject": "No runnable project detected in this workspace.",
  "session.preview.noProjectHint": "Add a package.json, index.html, or Python project, or enter a URL manually.",
  "session.preview.noDevScript": "No dev/start script found in package.json.",
  "session.preview.publish": "Publish",
  "session.preview.publishCos": "Publish to COS",
  "session.preview.publishCos.title": "Publish to Tencent Cloud COS",
  "session.preview.publishCos.project": "Project: {{name}}",
  "session.preview.publishCos.mode": "Deploy mode",
  "session.preview.publishCos.modeSubdomain": "Subdomain",
  "session.preview.publishCos.modeDomain": "Full domain",
  "session.preview.publishCos.subdomain": "Subdomain",
  "session.preview.publishCos.domain": "Full domain",
  "session.preview.publishCos.subdomainPlaceholder": "e.g. my-app",
  "session.preview.publishCos.domainPlaceholder": "e.g. app.example.com",
  "session.preview.publishCos.subdomainHint": "Will deploy under {{baseDomain}}",
  "session.preview.publishCos.protocol": "Protocol",
  "session.preview.publishCos.cdnHttps": "Enable CDN HTTPS",
  "session.preview.publishCos.certId": "CDN certificate ID",
  "session.preview.publishCos.certIdPlaceholder": "Required when HTTPS is enabled",
  "session.preview.publishCos.preview": "Preview deploy plan",
  "session.preview.publishCos.previewUrls": "URLs: {{urls}}",
  "session.preview.publishCos.previewCdn": "CDN domains: {{domains}}",
  "session.preview.publishCos.previewCos": "COS path: {{path}}",
  "session.preview.publishCos.previewExpanded": "Also configures: {{domains}}",
  "session.preview.publishCos.previewSkipCdn": "CDN already exists, will upload to COS only",
  "session.preview.publishCos.confirm": "Publish",
  "session.preview.publishCos.success": "Published successfully",
  "session.preview.publishCos.cosPath": "COS path: {{path}}",
  "session.preview.publishCos.cdnCname": "CDN {{domain}}: {{cname}}",
  "session.preview.publishCos.failed": "Publish failed",
  "session.preview.publishCos.previewFailed": "Could not preview deploy plan",
  "session.preview.publishCos.serverUnavailable": "Could not start deploy process. Set VITE_DEPLOY_CLI_SCRIPT and ensure Bun is available on the opencode serve host.",
  "session.preview.publishCos.configMissing": "Deploy config not found. Run: node packages/deploy-server/dist/cli.js config",
  "session.preview.publishCos.verificationTitle": "CDN ownership verification: {{domain}}",
  "session.preview.publishCos.verificationZone": "DNS zone: {{zone}}",
  "session.preview.publishCos.verificationType": "Record type: {{type}}",
  "session.preview.publishCos.verificationHost": "Host: {{host}}",
  "session.preview.publishCos.verificationValue": "Value: {{value}}",
  "session.preview.publishCos.verificationFqdn": "FQDN: {{fqdn}}",
  "session.preview.publishCos.verify": "Verify",
  "session.preview.publishCos.verificationPending": "Verification request sent. Checking DNS records…",
  "session.preview.publishCos.refreshVerification": "Refresh verification info",
  "session.preview.publishCos.verifyFailed": "Verification failed",
  "session.preview.publishCos.domainTaken": "These domains are already used by another project: {{domains}}",
  "session.preview.publishCos.routeDiscoveryTitle": "Route files detected. Choose how to discover links.",
  "session.preview.publishCos.routeDiscoveryCount": "{{count}} routes",
  "session.preview.publishCos.routeDiscoveryUseFile": "Use this route file",
  "session.preview.publishCos.routeDiscoveryUseBrowser": "Use browser crawling instead",
  "session.preview.publishCos.routeDiscoveryFailed": "Route selection failed",
  "session.preview.publishServer": "Publish to Server",
  "session.preview.publishServer.title": "Publish to server",
  "session.preview.publishServer.host": "Server host IP",
  "session.preview.publishServer.hostPlaceholder": "e.g. 192.168.1.100",
  "session.preview.publishServer.username": "Username",
  "session.preview.publishServer.password": "Password",
  "session.preview.publishServer.passwordPlaceholder": "SSH password",
  "session.preview.publishServer.domain": "Site domain",
  "session.preview.publishServer.domainPlaceholder": "e.g. www.example.com",
  "session.preview.publishServer.protocol": "Protocol",
  "session.preview.publishServer.path": "Remote path",
  "session.preview.publishServer.hint": "Enter domain, protocol, server IP, username, password, and remote path. Builds the project, generates sitemap.xml, robots.txt, and page markdown, then uploads dist. Domain, protocol, host, and path are saved to server-config.json.",
  "session.preview.publishServer.confirm": "Publish",
  "session.preview.publishServer.success": "Published successfully",
  "session.preview.publishServer.resultUrl": "Site URL: {{url}}",
  "session.preview.publishServer.resultHost": "Server: {{host}}",
  "session.preview.publishServer.resultPath": "Remote path: {{path}}",
  "session.preview.publishServer.resultUploaded": "Uploaded {{count}} files",
  "session.preview.publishServer.failed": "Server publish failed",
  "session.preview.publishServer.requiredFields": "Enter site domain, server IP, and password",
  "session.preview.publishServer.incomplete": "Publish did not finish. See the error message.",
  "session.preview.publishServer.starting": "Starting publish process…",
  "session.preview.publishServer.routeDiscoveryTitle": "Route files detected. Choose how to discover links.",
  "session.preview.publishServer.routeDiscoveryCount": "{{count}} routes",
  "session.preview.publishServer.routeDiscoveryUseFile": "Use this route file",
  "session.preview.publishServer.routeDiscoveryUseBrowser": "Use browser crawling instead",
  "session.preview.publishServer.routeDiscoveryFailed": "Route selection failed",
  "session.preview.undeploy": "Take offline",
  "session.preview.undeployCos.title": "Take offline: {{domain}}",
  "session.preview.undeployCos.loading": "Loading domains…",
  "session.preview.undeployCos.empty": "No published domains",
  "session.preview.undeployCos.success": "Taken offline successfully",
  "session.preview.undeployCos.domain": "Domain: {{domain}}",
  "session.preview.undeployCos.cdnStatus": "CDN: {{status}}",
  "session.preview.undeployCos.dnsStatus": "DNS: {{status}}",
  "session.preview.undeployCos.cosDeleted": "Deleted {{count}} COS objects",
  "session.preview.undeployCos.cosSkipped": "COS resources preserved",
  "session.preview.undeployCos.failed": "Take offline failed",
  "session.preview.gitflow": "GitFlow",
  "session.preview.gitflow.title": "GitFlow CI/CD Workflow Generator",
  "session.preview.gitflow.detecting": "Detecting project structure…",
  "session.preview.gitflow.detectFailed": "Project detection failed",
  "session.preview.gitflow.detection": "Detection results",
  "session.preview.gitflow.configure": "Configure deployment workflow",
  "session.preview.gitflow.routeCandidates": "Route candidates",
  "session.preview.gitflow.projectDir": "Project directory",
  "session.preview.gitflow.defaultDomain": "Default domain",
  "session.preview.gitflow.monorepoType": "Monorepo",
  "session.preview.gitflow.workspaceRoot": "Workspace root",
  "session.preview.gitflow.packageName": "Package name",
  "session.preview.gitflow.notFound": "(not found)",
  "session.preview.gitflow.notSet": "(not set)",
  "session.preview.gitflow.routesFileSelect": "Select routes file",
  "session.preview.gitflow.routesFileCustom": "Routes file path (custom)",
  "session.preview.gitflow.parsedRoutes.title": "Parsed routes",
  "session.preview.gitflow.parsedRoutes.loading": "Parsing routes…",
  "session.preview.gitflow.parsedRoutes.count": "{{count}} routes found",
  "session.preview.gitflow.parsedRoutes.empty": "No route paths could be parsed",
  "session.preview.gitflow.parsedRoutes.failed": "Failed to parse routes",
  "session.preview.gitflow.parsedRoutes.fileMissing": "Route file not found or unreadable",
  "session.preview.gitflow.subprojectPackageManager": "Subproject package manager",
  "session.preview.gitflow.workingDirectory": "Working directory: {{path}}",
  "session.preview.gitflow.framework": "Framework",
  "session.preview.gitflow.bundler": "Bundler",
  "session.preview.gitflow.language": "Language",
  "session.preview.gitflow.packageManager": "Package manager",
  "session.preview.gitflow.monorepo": "Subproject path",
  "session.preview.gitflow.routesFile": "Routes file path",
  "session.preview.gitflow.branch": "Deploy branch",
  "session.preview.gitflow.domain": "Site domain (without protocol)",
  "session.preview.gitflow.protocol": "Protocol",
  "session.preview.gitflow.installCmd": "Install command",
  "session.preview.gitflow.buildCmd": "Build command",
  "session.preview.gitflow.commandsTitle": "CI commands",
  "session.preview.gitflow.generate": "Generate files",
  "session.preview.gitflow.generating": "Generating…",
  "session.preview.gitflow.success": "GitFlow files generated",
  "session.preview.gitflow.successDetail": "The following files were written to the project:",
  "session.preview.gitflow.secretsTitle": "Next, configure these GitHub Secrets:",
  "session.preview.gitflow.optional": "optional",
  "session.preview.gitflow.pushHint": "Push to the {{branch}} branch to trigger deployment!",
  "session.preview.gitflow.failed": "Generation failed",
  "session.preview.gitflow.retry": "Retry",
  "session.preview.gitflow.workspaceWarning": "You are at the pnpm workspace root. Run this from a Vite subproject directory.",
  "session.preview.gitflow.workspaceWarningExample": "For example: cd apps/web && gitflow",
  ...
  "github.menu.tooltip": "GitHub projects",
  "github.menu.title": "Public repositories",
  "github.menu.search": "Search repositories",
  "github.menu.loading": "Loading repositories…",
  "github.menu.empty": "No public repositories found",
  "github.menu.disconnect": "Disconnect",
  "github.connect.title": "Connect GitHub",
  "github.connect.description": "Link your GitHub account to browse public repositories and open them on this machine.",
  "github.connect.action": "Connect GitHub",
  "github.connect.inProgress": "Connecting to GitHub…",
  "github.connect.device.action": "Continue with GitHub device login",
  "github.connect.device.prefix": "Visit ",
  "github.connect.device.link": "GitHub",
  "github.connect.device.suffix": " and enter the code below.",
  "github.connect.device.code": "Verification code",
  "github.connect.device.waiting": "Waiting for authorization…",
  "github.connect.token.action": "Use personal access token",
  "github.connect.token.label": "Personal access token",
  "github.connect.token.placeholder": "ghp_…",
  "github.open.failed": "Failed to open repository",
  "github.open.missingDirectory": "Could not resolve the current working directory. Open a project first.",
