import type { GitflowConfig } from "./types.js"

/**
 * 生成 workflow 中解析站点 URL 的 shell 片段
 * 优先级: 1. gitflow 用户输入  2. SITE_URL secret  3. www.仓库名.com
 */
function buildSiteUrlShell(cfg: GitflowConfig, { exportEnv = false }: { exportEnv?: boolean } = {}) {
 ...
 */
export function generateWorkflowYaml(cfg: GitflowConfig) {
